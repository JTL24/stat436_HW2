      ...
      tabsetPanel(
        ...
        tabPanel("About",
                 ...
                 p("This interactive dashboard allows you to explore NBA player statistics 
                   ...
                   player performance over time. You can view individual performance on various statistics and various                    time periods throughout the season."),
                 h4("Data Source"),
                 p("The data was obtained on Kaggle: https://www.kaggle.com/datasets/drgilermo/nba-players-stats/data"),
                 p("This contains player statistics from the current NBA season."))
      )
    )
  )
)
